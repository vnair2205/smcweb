            ...
            <div class="footer-row">
                ...
                <div class="link-section">
                    ...
                    <div class="footer-content">
                        <ul>
                            <li><a data-cursor="pointer" href="#">AI Course Generation</a></li>
                            <li><a data-cursor="pointer" href="#">Pre-Generated Courses</a></li>
                            <li><a data-cursor="pointer" href="#">Practice Quizzes</a></li>
                            <li><a data-cursor="pointer" href="#">AI Tutor</a></li>
                             <li><a data-cursor="pointer" href="#">Multilingual Support</a></li>
                            <li><a data-cursor="pointer" href="#">Verifiable Certificates</a></li>
                        </ul>
                    </div>
                </div>
                <div class="link-section">
                    ...
                    <div class="footer-content">
                        <ul>
                            <li><a data-cursor="pointer" href="#">Our Story & Mission</a></li>
                            <li><a data-cursor="pointer" href="#">Our Team</a></li>
                            <li><a data-cursor="pointer" href="#">Awards & Recognition</a></li>
                            <li><a data-cursor="pointer" href="#">Careers</a></li>
                        </ul>
                    </div>
                </div>
                <div class="link-section">
                    ...
                    <div class="footer-content">
                        <ul>
                            <li><a data-cursor="pointer" href="#">Blogs</a></li>
                            <li><a data-cursor="pointer" href="#">Help & Support</a></li>
                        #
                        </ul>
                    </div>
                </div>
