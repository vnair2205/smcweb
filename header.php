 <!-- header start -->
    <header>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                      <li>
                                        <a class="dropdown-item" href="Features/AI-Course-Generation.php">AI Course Generation</a>
                                    </li>
                                     <li>
                                        <a class="dropdown-item" href="Features/AI-Tutor.php">AI Tutor</a>
                                    </li>
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="Features/Practice-Quizzes.php">Practice Quizzes</a>
                                    </li>
                                ...
                                <ul class="dropdown-menu">
                                   <li>
                                        <a class="dropdown-item" href="About-Us/Our-Story-&-Mission.php">Our Story & Mission</a>
                                    </li>
                                      <li>
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="About-Us/">Careers</a>
                                    </li> -->
                            ...
                            <li class="nav-item">
                             ...
                             <li class="nav-item">
                                <a class="nav-link" href="https://app.seekmycourse.com/" target="_blank">Login</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="https://app.seekmycourse.com/signup" target="_blank">Signup</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <a data-cursor="pointer" href="https://app.seekmycourse.com/" target="_blank" class="btn btn-theme d-sm-inline-block d-none"><span>Get Started
                Now</span></a>
